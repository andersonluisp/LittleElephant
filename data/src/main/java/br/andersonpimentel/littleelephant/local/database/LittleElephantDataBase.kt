package br.andersonpimentel.littleelephant.local.database

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import br.andersonpimentel.littleelephant.local.database.dao.DateCacheValidateDao
import br.andersonpimentel.littleelephant.local.database.dao.ElephantPositionDao
import br.andersonpimentel.littleelephant.local.database.dao.MessagesDao
